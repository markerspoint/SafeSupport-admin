...
<section>
    ...
    <div class="mb-4 tab-wrapper p-3">
        <ul class="nav nav-tabs" id="dashboardTabs" role="tablist">
            <li class="nav-item col-md-3 mb-2 p-0">
                <a class="nav-link tab-card active text-center p-3" id="appointments-tab" data-toggle="tab" href="#appointments" role="tab" aria-controls="appointments" aria-selected="true">
            ...
            <li class="nav-item col-md-3 mb-2 p-0">
                <a class="nav-link tab-card text-center p-3" id="resources-tab" data-toggle="tab" href="#resources" role="tab" aria-controls="resources" aria-selected="false">
            ...
            <li class="nav-item col-md-3 mb-2 p-0">
                <a class="nav-link tab-card text-center p-3" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
            ...
            <li class="nav-item col-md-3 mb-2 p-0">
                <a class="nav-link tab-card text-center p-3" id="calendar-tab" data-toggle="tab" href="#calendar" role="tab" aria-controls="calendar" aria-selected="false">
