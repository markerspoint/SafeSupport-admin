...
<head>
    ...
    <title>SafeSupport | Admin Login</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center animated fadeInDown">
        <div>
            ...
            <p class="login-box-msg">Admin Access Only</p>
        </div>
        ...
        <form class="m-t" role="form" action="{{ route('admin.login.submit') }}" method="POST">
            ...
            <div class="form-floating form-group">
                <input type="password" class="form-control b-r-lg" id="password" name="password" placeholder="" required>
        ...
        <p class="m-t"> <small>SafeSupport Admin Portal &copy; 2025</small> </p>
    </div>
